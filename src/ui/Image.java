...
public class Image implements Component {
	...
	public Image(String texturePath, float x, float y) {
		this(TextureUtils.createTexture(texturePath), x, y);
	}

	public Image(String texturePath, float x, float y, float w, float h, Vector3f color) {
		this(TextureUtils.createTexture(texturePath), x, y, w, h, color);
	}
	
	public Image(Texture texture, float x, float y, float w, float h, Vector3f color) {
		gfx = texture;
		this.x = x;
		this.y = y;
		this.w = w;
